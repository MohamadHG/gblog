...
<head>
    ...
    <title>G-Blog/ChangePassword</title>
    <style>
        body {
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top" style="background-color:#804000;font-family:sans-serif;">
        ...
        <div class="d-flex">
          <div class="collapse navbar-collapse" id="mynavbar">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" style="border-bottom: 1px solid darkgray;" href="resetPass.php">Change Password</a>
              </li>
    ...
    <center>
        <h1 class="fw-light text-center text-lg-start mt-4 mb-0 col-xl-3 col-xxl-3 col-lg-3 col-sm-10 col-md-3" style="border-bottom:1px black solid;color:white;">Change Password</h1>
        <form action="resetPassaction.php" method="POST" class="col-xl-4 col-xxl-4 col-lg-4 col-sm-10 col-md-4">
            <img src="pics/G_Blog_Logo.png" alt="G-Blog" style="height:159px;margin-bottom:20px;float:center;width:190px;">
            <table style="float: center;">
                <tr>
                    <td class="input-group">
                        <input type="password" placeholder="Old Password" class="in" name="op" required>
                        <span class="border-buttom"></span>
                    </td>
                </tr>
                <tr>
                    <td class="input-group">
                        <input type="password" placeholder="New Password" name="np" class="in" required>
                        <span class="border-buttom"></span>
                    </td>
                </tr>
                <tr>
                    <td class="input-group">
                        <input type="password" placeholder="Confirm Password" class="in" name="cnp" required>
                        <span class="border-buttom"></span>
                    </td>
                </tr>
                <tr>
