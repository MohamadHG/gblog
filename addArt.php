...
<head>
    ...
    <title>G-Blog/Add_Article</title>
    <style>
        form {
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top" style="background-color:#804000;font-family:sans-serif;">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="mynavbar"> <!-- me-auto in the class to return the a tags to the edges -->
        ...
        <div class="d-flex">
          <div class="collapse navbar-collapse" id="mynavbar">
            ...
            <li class="nav-item">
              <a class="nav-link active" style="border-bottom: 1px solid darkgray;" href="addArt.php"> Add Article</a>
              </li>
              <li class="nav-item">
    ...
    <center>
        <h1 class="fw-light text-center text-lg-start mt-4 mb-0 col-xl-3 col-xxl-3 col-lg-3 col-sm-10 col-md-3" style="border-bottom:1px black solid;color:white;">Post an Article</h1>
            <form action="addArticleaction.php" method="POST" enctype="multipart/form-data" class="col-xl-5 col-xxl-5 col-lg-5 col-sm-12 col-md-5">
                <table>
                    <tr style="text-align: center;">
                        <td><img src="pics/G_Blog_Logo.png" alt="G-Blog" style="height:150px;width:170px;"></td>
                    </tr>
                    <tr>
                        <td>Enter your Post's Headline:</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><textarea name="article" cols="60" rows="10" spellcheck="true" required></textarea></td>
                    </tr>
                    <tr>
                        <td>
                            <hr>Submit an image for the post:
                        </td>
                    </tr>
                    <tr>
                        <td><input type="file" id="uploadfile" required name="uploadfile"></td>
                    </tr>
                    <tr>
                        <td>
                            <br><input type="reset" class="btn btn-outline-dark">
